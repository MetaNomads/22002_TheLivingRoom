...
public class GenerateShape : MonoBehaviour
{
    ...
    public PhysicMaterial tubePhysics;
    ...
    {
        origin = GetComponent<GazeInteractable>().GetGazeInteractor().transform.position;
    ...
    Vector3 getViewPoint() {
        ...
        viewpoint = GetComponent<GazeInteractable>().GetGazeInteractor().getGazePoint();
        return viewpoint;
    }
